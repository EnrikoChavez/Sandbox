...
estimator = svm.SVC(random_state=0) #TODO choose two different kernel functions (for analysis)

#validation curve
# disp = ValidationCurveDisplay.from_estimator(estimator = estimator, X=X, y=y.flatten(), param_name="C", param_range=np.logspace(-5, 7, 10))
