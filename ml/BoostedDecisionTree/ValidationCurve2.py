...
#validation curve
disp = ValidationCurveDisplay.from_estimator(estimator = estimator, X=X, y=y.flatten(), param_name="learning_rate", param_range=np.logspace(-5, 4, 20))
disp.ax_.set_title("Validation Curve for Boosted Trees")
disp.ax_.set_xlabel(r"learning rate")
